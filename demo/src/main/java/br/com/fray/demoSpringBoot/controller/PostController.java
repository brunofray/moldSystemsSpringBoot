package br.com.fray.demoSpringBoot.controller;
...
import br.com.fray.demoSpringBoot.service.PostService;


@Controller //Define a classe como um bean do Spring
public class PostController {
	// RESPONSAVEL POR INTERMEDIAR A COMUNICAÇÃO ENTRE AS VIEWS DO THYMELEAF E A CAMADA DE SERVIÇOS.
	
	@Autowired
	private PostService service; //	Injeta a classe de serviços
	
	// Recebe o nome dos templates criados anteriormente e transfere de forma bilateral dados entre view e controller
