package br.com.fray.demoSpringBoot.model;
...
public class Post implements Serializable{
	...
	// Anotações do JPA definem características das colunas
	
	// Anotações que recebem a string message tem objetivo de 
	// validar o preenchimento desses atributos
	
	@Id
	//Cria uma sequence para ser usada com a tabela
