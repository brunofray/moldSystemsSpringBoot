...
CREATE TABLE springboot_mysql_webapp.tb_grupo
(
...
CREATE TABLE springboot_mysql_webapp.tb_permissao
(
...
CREATE TABLE springboot_mysql_webapp.tb_usuario
(
...
CREATE TABLE springboot_mysql_webapp.tb_usuario_x_grupo
(
...
CREATE TABLE springboot_mysql_webapp.tb_permissao_x_grupo
(
...
INSERT INTO springboot_mysql_webapp.tb_grupo(id_grupo,
                             ds_nome,
                             ds_descricao) 
...
INSERT INTO springboot_mysql_webapp.tb_usuario (id_usuario,
                                ds_nome,
                                ds_login,
                                ds_senha,
                                fl_ativo)
...
INSERT INTO springboot_mysql_webapp.tb_permissao(id_permissao,
                                  ds_permissao,
                                  ds_descricao)
...
INSERT INTO springboot_mysql_webapp.tb_usuario_x_grupo(id_usuario,id_grupo)VALUES(1,1);



/*ROLE_CADASTROUSUARIO x BACKOFFICE*/
INSERT INTO springboot_mysql_webapp.tb_permissao_x_grupo(id_permissao,id_grupo)VALUES(1,3); 

/*ROLE_CONSULTAUSUARIO x USUARIOS*/
INSERT INTO springboot_mysql_webapp.tb_permissao_x_grupo(id_permissao,id_grupo)VALUES(2,2);

/*ROLE_ADMIN x ADMINISTRADORES*/
INSERT INTO springboot_mysql_webapp.tb_permissao_x_grupo(id_permissao,id_grupo)VALUES(3,1);
